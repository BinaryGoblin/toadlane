...
ActiveRecord::Schema.define(version: 20141002211243) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "armor_bank_accounts", force: true do |t|
  ...
  create_table "armor_invoices", force: true do |t|
    t.integer  "buyer_id"
    t.integer  "seller_id"
  ...
  create_table "armor_orders", force: true do |t|
    t.integer  "buyer_id"
    t.integer  "seller_id"
  ...
  create_table "armor_profiles", force: true do |t|
  ...
  create_table "pricebreaks", force: true do |t|
    t.integer  "quantity"
    t.float    "price"
    t.integer  "product_id"
    t.datetime "created_at"
