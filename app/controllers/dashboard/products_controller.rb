class Dashboard::ProductsController < DashboardController
  ...
  def product_params
    ...
    .permit(:id, :name, :negotiable, :description,
      ...
      :product_categories_attributes, :default_payment,
      ...
      :certificates_attributes => [:uploaded_file], :certificates_attributes_delete => [],
      ...
      :pricebreaks_delete => [], :inspection_dates_attributes => [:date],
